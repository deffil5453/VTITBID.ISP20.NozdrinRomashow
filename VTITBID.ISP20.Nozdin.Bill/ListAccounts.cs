...
namespace VTITBid.ISP20.Nozdrin.Bill
{
    class ListAccounts : IComparable
    {        
        private string _PayerAccount { get; set; }
        private string _RcipientAccount { get; set; }
        ...
        public string RcipientAccount
        {
            get { return _RcipientAccount; }
            set
            {
                _RcipientAccount = value;
            }
        }
        public double AMountTransferred
        {
            get { return _AMountTransferred; }
            set
            {
